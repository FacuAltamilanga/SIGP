  ...
  return (
    <main className="grid min-h-screen bg-[#f1f3f7] lg:grid-cols-[52%_48%]">
      ...
      <section className="flex items-center justify-center px-6 py-8 sm:px-10"><div className="w-full max-w-[390px]">
        ...
        <section className="mt-5 rounded-md border border-blue-200 bg-[#d5e4f7] p-3.5 text-xs leading-6 text-slate-600"><p className="font-bold text-blue-800">Credenciales de demostración</p><p>Recepción: <code className="font-mono text-blue-800">admin@sigp / admin123</code></p><p>Enfermería: <code className="font-mono text-blue-800">enfermeria@sigp / enfermeria123</code></p><p>Médico: <code className="font-mono text-blue-800">medico@sigp / medico123</code></p></section>
