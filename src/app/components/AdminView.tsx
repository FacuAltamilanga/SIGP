...
export function AdminView() {
  ...
  async function createAppointment(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const response = await fetch(`${getApiUrl()}/turnos`, { method: 'POST', headers, body: JSON.stringify({ fecha: booking.fecha, hora: booking.hora, dni: booking.dni, nombre_paciente: `${booking.nombre} ${booking.apellido}`.trim(), motivo: booking.motivo }) });
